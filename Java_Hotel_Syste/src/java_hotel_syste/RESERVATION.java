...
public class RESERVATION extends MY_CONNECTION{
    
    MY_CONNECTION my_connection=new MY_CONNECTION();
    ROOMS room=new ROOMS();
    
    //Rzervasyon ekleme işlemi veritabaı kontrolünde yapılmıştır.
    public boolean addReservation(int client_id,int room_number,String dateIn , String dateOut)
    {
        ...
        try {
            ...
            {
                 JOptionPane.showMessageDialog(null,"Bu Oda Daha Önceden Rezerve Edilmiştir.", "Oda Rezerve", JOptionPane.WARNING_MESSAGE);
                return false;
            }
       ...
       //Rezervasyon güncelleme işlemi veritabaı kontrolünde yapılmıştır.
    public boolean editReservation(int reservation_id,int client_id,int room_number,String dateIn,String dateOut)
    {
       ...
       //Rezervasyon silme işlemi veritabaı kontrolünde yapılmıştır.
